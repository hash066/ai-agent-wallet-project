...
- [Threat Model](docs/security/THREAT_MODEL.md) - 10+ attack scenarios analyzed
- [Testing Strategy](docs/security/TESTING_STRATEGY.md) - How we test security
- [Audit Checklist](docs/security/AUDIT_CHECKLIST.md) - Self-audit findings
- [Residual Risks](docs/security/RESIDUAL_RISKS.md) - Known v1 limitations
